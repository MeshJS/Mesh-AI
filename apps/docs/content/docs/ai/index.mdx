...
1. No API keys required - works with any AI provider out of the box.

2. Restart your editor after saving the config.

3. Get help to code faster with Mesh MCP and AI editor
